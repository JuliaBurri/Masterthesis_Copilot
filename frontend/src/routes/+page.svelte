<script lang="ts">
	...
	async function addTask() {
        var id = fetch('http://localhost:8080/api/tasks', {
            method: 'POST',
            headers: {
...
<div class="container">
	...
	<div class="add-task-container">
		...
		<input bind:value={title} type="text" placeholder="Task title" />
		<input bind:value={description} type="text" placeholder="Task description" />
		<input bind:value={duration} type="number" placeholder="Task duration" />
		<p>Priority</p>
